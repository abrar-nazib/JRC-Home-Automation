...
html_files = [file for file in os.listdir(
    html_directory) if file.endswith('.html')]
...
for file in html_files:
    ...
    include_guard = '_'.join(os.path.splitext(
        new_file_name)[0].split()).upper()
    ...
    print(
        f"File '{file}' copied and renamed to '{new_file_name}' in the '{include_directory}' directory.")
